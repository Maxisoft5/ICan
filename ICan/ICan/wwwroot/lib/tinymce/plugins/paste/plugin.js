...
var paste = (function () {
    ...
    var firePastePreProcess = function (editor, html, public, isWordHtml) {
    ...
    var firePastePostProcess = function (editor, node, public, isWordHtml) {
    ...
    var register = function (editor, clipboard, userIsInformedState) {
      ...
      editor.addCommand('mceInsertClipboardContent', function (ui, value) {
        if (value.content) {
          clipboard.pasteHtml(value.content, value.public);
        }
        if (value.text) {
    ...
    function isWordContent(content) {
      return /<font face="Times New Roman"|class="?Mso|style="[^"]*\bmso-|style='[^'']*\bmso-|w:WordDocument/i.test(content) || /class="OutlineElement/.test(content) || /id="?docs\-public\-guid\-/.test(content);
    }
    ...
    var postProcessFilter = function (editor, html, public, isWordHtml) {
      var tempBody = editor.dom.create('div', { style: 'display:none' }, html);
      var postProcessArgs = Events.firePastePostProcess(editor, tempBody, public, isWordHtml);
      return processResult(postProcessArgs.node.innerHTML, postProcessArgs.isDefaultPrevented());
    };
    var filterContent = function (editor, content, public, isWordHtml) {
      var preProcessArgs = Events.firePastePreProcess(editor, content, public, isWordHtml);
      if (editor.hasEventListeners('PastePostProcess') && !preProcessArgs.isDefaultPrevented()) {
        return postProcessFilter(editor, preProcessArgs.content, public, isWordHtml);
      } else {
        return processResult(preProcessArgs.content, preProcessArgs.isDefaultPrevented());
      }
    };
    var process = function (editor, html, public) {
      var isWordHtml = WordFilter.isWordContent(html);
      var content = isWordHtml ? WordFilter.preProcess(editor, html) : html;
      return filterContent(editor, content, public, isWordHtml);
    };
    ...
    var pasteHtml$1 = function (editor, html, internalFlag) {
      var public = internalFlag ? internalFlag : InternalHtml.isMarked(html);
      var args = ProcessFilters.process(editor, InternalHtml.unmark(html), public);
    ...
    var getDataTransferItems = function (dataTransfer) {
      var items = {};
      var mceInternalUrlPrefix = 'data:text/mce-public,';
      if (dataTransfer) {
    ...
    var registerEventHandlers = function (editor, pasteBin, pasteFormat) {
      ...
      function insertClipboardContent(clipboardContent, isKeyBoardPaste, plainTextMode, public) {
        var content, isPlainTextHtml;
        if (hasContentType(clipboardContent, 'text/html')) {
          content = clipboardContent['text/html'];
        } else {
          content = pasteBin.getHtml();
          public = public ? public : InternalHtml.isMarked(content);
        ...
        pasteBin.remove();
        isPlainTextHtml = public === false && Newlines.isPlainText(content);
        ...
        if (plainTextMode) {
          ...
          pasteHtml$1(editor, content, public);
        }
      }
      ...
      editor.on('paste', function (e) {
        ...
        var public = hasContentType(clipboardContent, InternalHtml.internalHtmlMime());
        ...
        if (hasContentType(clipboardContent, 'text/html')) {
          e.preventDefault();
          if (!public) {
            public = InternalHtml.isMarked(clipboardContent['text/html']);
          }
          insertClipboardContent(clipboardContent, isKeyBoardPaste, plainTextMode, public);
        } else {
    ...
    var setup = function (editor, clipboard, draggingInternallyState) {
      ...
      editor.on('drop', function (e) {
        ...
        var public = clipboard.hasContentType(dropContent, InternalHtml.internalHtmlMime());
        if ((!clipboard.hasHtmlOrText(dropContent) || isPlainTextFileUrl(dropContent)) && clipboard.pasteImageData(e, rng)) {
          return;
        }
        if (rng && Settings.shouldFilterDrop(editor)) {
          var content_1 = dropContent['mce-public'] || dropContent['text/html'] || dropContent['text/plain'];
          if (content_1) {
            e.preventDefault();
            global$2.setEditorTimeout(editor, function () {
              editor.undoManager.transact(function () {
                if (dropContent['mce-public']) {
                  editor.execCommand('Delete');
                }
                ...
                if (!dropContent['text/html']) {
                  ...
                  clipboard.pasteHtml(content_1, public);
                }
              });
            });
          }
    ...
    function addPreProcessFilter(editor, filterFunc) {
      editor.on('PastePreProcess', function (e) {
        e.content = filterFunc(editor, e.content, e.public, e.wordContent);
      });
    }
    ...
    function removeWebKitStyles(editor, content, public, isWordHtml) {
      if (isWordHtml || public) {
        return content;
      }
