...
namespace ICan.Data.Migrations
{
    ...
    [Migration("20210124100003_move_is_assembled")]
    partial class move_is_assembled
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ICan.Data.OptCountry", b =>
                {
            ...
            modelBuilder.Entity("ICan.Data.OptMarketplace", b =>
                {
            ...
            modelBuilder.Entity("ICan.Data.OptMarketplaceProduct", b =>
                {
            ...
            modelBuilder.Entity("ICan.Data.OptMarketplaceProductReview", b =>
                {
                    b.Property<int>("MarketplaceProductReviewId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("MarketplaceProductReviewId");

                    b.HasIndex("MarketplaceProductId");

                    b.ToTable("opt_marketplaceproductreview");
                });
            ...
            modelBuilder.Entity("ICan.Data.OptPaperOrderIncoming", b =>
                {
            ...
            modelBuilder.Entity("ICan.Data.OptProduct", b =>
                {
                    ...
                    b.Property<int?>("SiteDisplayOrder")
                        .HasColumnType("int");

                    b.Property<bool>("SiteEnabled")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("ICan.Data.OptProductImage", b =>
                {
            ...
            modelBuilder.Entity("ICan.Data.OptProductTag", b =>
                {
            ...
            modelBuilder.Entity("ICan.Data.OptSemiproductProductRelation", b =>
                {
                    b.Property<int>("SemiproductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ICan.Data.OptSiteFilter", b =>
                {
            ...
            modelBuilder.Entity("ICan.Data.OptSiteFilterProduct", b =>
                {
            ...
            modelBuilder.Entity("ICan.Data.OptTag", b =>
                {
                    b.Property<int>("TagId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ICan.Data.OptTypeOfPaper", b =>
                {
                    b.Property<int>("TypeOfPaperId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ICan.Data.OptWarehouseType", b =>
                {
                    b.Property<int>("WarehouseTypeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ICan.Data.OptAssembly", b =>
                {
                    ...
                    b.HasOne("ICan.Data.OptWarehouse", "Warehouse")
                        .WithOne("Assembly")
                        .HasForeignKey("ICan.Data.OptAssembly", "WarehouseId")
            ...
            modelBuilder.Entity("ICan.Data.OptMarketplaceProduct", b =>
                {
                    b.HasOne("ICan.Data.OptMarketplace", "Marketplace")
            ...
            modelBuilder.Entity("ICan.Data.OptMarketplaceProductReview", b =>
                {
                    b.HasOne("ICan.Data.OptMarketplaceProduct", "MaretplaceProduct")
                        .WithMany("Reviews")
                        .HasForeignKey("MarketplaceProductId")
                        .HasConstraintName("Opt_MarketplaceProductReview_MarketplaceProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ICan.Data.OptPaper", b =>
                {
                    b.HasOne("ICan.Data.OptTypeOfPaper", "TypeOfPaper")
                        .WithMany("Papers")
            ...
            modelBuilder.Entity("ICan.Data.OptPaperOrderIncoming", b =>
                {
                    ...
                    b.HasOne("ICan.Data.OptWarehouseType", "WarehouseType")
                        .WithMany("PaperOrderIncomings")
            ...
            modelBuilder.Entity("ICan.Data.OptProduct", b =>
                {
                    b.HasOne("ICan.Data.OptCountry", "Country")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ICan.Data.OptSiteFilterProduct", b =>
                {
                    ...
                    b.HasOne("ICan.Data.OptSiteFilter", "SiteFilter")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ICan.Data.OptWarehouseType", b =>
                {
                    b.HasOne("ICan.Data.OptCounterparty", "Counterparty")
